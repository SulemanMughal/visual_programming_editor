  ...
  return (
    <div style={style}>
      <div
        ...
        role="row"
      >
        <div className="min-w-0 flex items-center h-10 px-4 gap-2" role="cell">
          {/* indent */}
          <div style={{ width: n.depth * 16, flex: "0 0 auto" }} />
          ...
          {/* KEY — clickable, no selection state */}
          <button
            type="button"
            onClick={() => onAction({ id, path: n.path, node: n })}
            className={`truncate text-left font-medium ${
              isMatch ? "text-blue-700" : "text-gray-900"
            } hover:underline focus:outline-none active:opacity-70`}
            title={id}
          >
...
/* ===================== Main (key-click version) ===================== */
export default function JsonTreeGridVirtActionKey({
  json,
  onAction,
}: {
  json: J;
